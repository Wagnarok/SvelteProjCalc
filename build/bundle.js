var app = (function () {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*materials*/ 1) {
    			 $$invalidate(1, totalCost = materials.reduce(
    				(prev, next) => {
    					prev += next.price;
    					return prev;
    				},
    ...
    function create_fragment$2(ctx) {
    	...
    	function form_name_binding(value) {
    		/*form_name_binding*/ ctx[5].call(null, value);
    	}

    	function form_id_binding(value) {
    		/*form_id_binding*/ ctx[6].call(null, value);
    	}
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [id, name, price, edit, form_price_binding, form_name_binding, form_id_binding];
    }
